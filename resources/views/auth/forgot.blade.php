    ...
    <div class="h-screen bg-white flex flex-col space-y-10 justify-center items-center">
        <div class="bg-white w-96 shadow-xl rounded p-5">
            ...
            <form class="space-y-5 mt-5" method="POST" action="{{ route('forgot_process') }}">
                ...
                <input type="text" class="w-full h-12 border rounded px-3 @error('text') border-red-500 @enderror" placeholder="Email" />
                @error('text')
                ...
                <button type="submit"
                    class="text-center w-full bg-blue-900 rounded-md text-white py-3 font-medium">Восстановить</button>
            </form>
        </div>
    </div>
@endsection
